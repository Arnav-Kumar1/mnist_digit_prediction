...
function getTouchCoordinates(e) {
  ...
  if (orientation === 'landscape-primary') {
    y = (e.touches[0].clientY - rect.top) * (canvas.width / rect.height);
    x = (e.touches[0].clientX - rect.left) * (canvas.height / rect.width);
  } else if (orientation === 'landscape-secondary') {
    x = ((e.touches[0].clientX - rect.left) * (canvas.width / rect.height));
    y = ((e.touches[0].clientY - rect.top) * (canvas.height / rect.width));
  } else {
